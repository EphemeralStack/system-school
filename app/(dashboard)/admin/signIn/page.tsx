...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Login the user - login function now returns user data
      ...
      if (userData.Role !== 'admin') {
        throw new Error('This account is not an admin account. Please use the correct login page.')
      }

      // 3. Check if admin is active
      if (userData.Status && userData.Status === 'inactive') {
        throw new Error('Your account is inactive. Please contact the system administrator.')
      }
        ...
        <div className="bg-[#232A42]/80 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/10">
          ...
          <div className="text-center mb-8">
            ...
            <div className="inline-flex items-center gap-2 mt-2 px-3 py-1 bg-blue-500/20 rounded-full">
              ...
              <span className="text-xs text-blue-300">Administrator Access</span>
            </div>
          </div>
