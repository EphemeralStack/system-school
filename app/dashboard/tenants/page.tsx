                          ...
                          <div className="p-4 sm:p-5">
                            ...
                            <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 mt-3 sm:mt-4 pt-1 sm:pt-2">
                              <button
                                ...
                                className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-xl transition-all duration-200 font-medium text-xs sm:text-sm shadow-sm hover:shadow-md"
                              >
                              ...
                              <button
                                ...
                                className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all duration-200 font-medium text-xs sm:text-sm shadow-sm hover:shadow-md"
                              >
                          ...
                          <div className="p-4 sm:p-5">
                            ...
                            <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 mt-3 sm:mt-4 pt-1 sm:pt-2">
                              <Link
                                ...
                                className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition-all duration-200 font-medium text-xs sm:text-sm shadow-sm hover:shadow-md"
                              >
