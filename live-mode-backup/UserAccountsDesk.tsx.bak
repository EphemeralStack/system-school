  ...
  const notifications = [
    {
      ...
      description:
        'Review pending and restricted accounts before approving access.',
      Icon: ShieldAlert,
    },
    {
      title:
      ...
      description:
        'Confirm every user has a matching role-specific profile.',
      Icon: Users,
    },
    {
      title:
        'Security Log Source',
      description:
        'Failed-login and blocked-IP telemetry is not connected yet.',
      Icon: KeyRound,
    },
  ]
